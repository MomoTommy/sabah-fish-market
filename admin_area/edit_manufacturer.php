...
<i class="fa fa-dashboard"></i> Dashboard / Edit Stores
...
<i class="fa fa-money fa-fw"> </i> Edit Stores
</h3><!-- panel-title Ends -->
...
<label class="col-md-3 control-label"> Show as Top Store </label>
...
<label class="col-md-3 control-label"> Select Store Image </label>
...
<input type="submit" name="update" class="form-control btn btn-primary" value=" Update Store " >
