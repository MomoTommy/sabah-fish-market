...
<label class="col-md-5 control-label" >Product Weight (Kg)</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<input class="form-control" type="text" placeholder="1" name="product_qty">
...
<h3 class="text-center"><br><br><br>You may also like these products: </h3>
